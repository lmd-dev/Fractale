...
void FractaleMandelbrot::draw(Bitmap& bitmap, const double& xCenter, const double& yCenter, const double& width, const unsigned int& maxIteration, unsigned int (*colorize)(const unsigned int& iteration, const unsigned int& maxIteration))
{
